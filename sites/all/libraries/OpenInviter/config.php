<?php
	$openinviter_settings=array(
		"username"=>"trevon",
		"private_key"=>"89e1b2cb99a1c342019430d83796e9ef",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to http://test3.themesnap.net", // http://test3.themesnap.net is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to http://test3.themesnap.net", // http://test3.themesnap.net is the website on your account. If wrong, please update your account at OpenInviter.com
